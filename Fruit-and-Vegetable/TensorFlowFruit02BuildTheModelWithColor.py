...
train_data = load('D:/20212/AI/temp/train_data.npy')
train_data_lables = load('D:/20212/AI/temp/train_data_labels.npy')
test_data = load('D:/20212/AI/temp/test_data.npy')
test_data_big = load('D:/20212/AI/temp/test_data_big.npy')
test_data_labels = load('D:/20212/AI/temp/test_data_labels.npy')
...
class_index = np.argmax(predictions[15]) # get the max value
print(class_index)
