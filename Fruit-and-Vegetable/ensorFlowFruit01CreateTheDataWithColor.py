...
rootdir = "D:/20212/AI/Fruit-and-Vegetable/train"
...
save('D:/20212/AI/temp/train_data.npy', train_data)
save('D:/20212/AI/temp/train_data_labels.npy', train_data_lables)


#lets continue to the test data 
print("Start loading the test data ")
rootdir = "D:/20212/AI/Fruit-and-Vegetable/test"
...
# save the numpy arays as numpy binary to the disk 
save('D:/20212/AI/temp/test_data.npy', test_data)
save('D:/20212/AI/temp/test_data_big.npy', test_data_big)
save('D:/20212/AI/temp/test_data_labels.npy', test_data_labels)
